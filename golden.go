...
// seal it once, clone it for free. This is the klab/kimage golden
...
func MakeGolden(r Row, progress func(string)) error {
	...
	// root would make clones that boot and then have nothing to serve.
